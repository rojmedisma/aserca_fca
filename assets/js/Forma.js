...
var Forma = function(){
	...
	function navTabFrmActivar(v_cat_cuest_modulo_id, v_ver_res_gen, v_ver_semaforo, v_ver_res_cmpte){
		...
		try{
			...
			}else if(v_ver_semaforo){
				$('#tab_semaforo').addClass('active');
				$('#tab_semaforo_tab').addClass('active');
			}else if(v_ver_res_cmpte){
				$('#tab_res_cmpte').addClass('active');
				$('#tab_res_cmpte_tab').addClass('active');
			}else{
	...
	return {
		...
		activaFormaEventos:function(v_cat_cuest_modulo_id, v_ver_res_gen, v_ver_semaforo, v_ver_res_cmpte){
			var vi_cat_cuest_modulo_id = parseInt(v_cat_cuest_modulo_id);
			var vi_v_ver_res_gen = parseInt(v_ver_res_gen);
			var vi_v_ver_semaforo = parseInt(v_ver_semaforo);
			var vi_v_ver_res_cmpte = parseInt(v_ver_res_cmpte);
			navTabFrmActivar(vi_cat_cuest_modulo_id, vi_v_ver_res_gen, vi_v_ver_semaforo, vi_v_ver_res_cmpte);
